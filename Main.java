    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < personajes.length; i++) {
            ...
            do {
                ...
                if(personajes[i].getVidaActual() > 0){//si el monstruo sobrevive se muestra su vida restante
                ...
                if(jugador.getVidaActual() > 0){//si el jugador sobrevive se muestra su vida restante
